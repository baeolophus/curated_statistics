...
\urlstyle{same}
\hypersetup{
  pdftitle={Statistics for Scared People},
  pdfauthor={C.M. Curry},
  hidelinks,
...
\includegraphics{statistics_for_scared_people_files/figure-latex/pressure-1.pdf}
...
\addcontentsline{toc}{chapter}{How to use this section}
...
\addcontentsline{toc}{chapter}{Principal components analysis}
...
\addcontentsline{toc}{chapter}{What each section has}
